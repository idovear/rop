...
public class ServletRequestContextBuilderTest {
    ...
    public void testBuildBySysParams1() throws Exception {
        ...
        servletRequest.setParameter(SystemParameterNames.getAccess_token(), "sessionId1");
        ...
        assertEquals(requestContext.getAccess_token(), "sessionId1");
    ...
    public void testBuildBySysParams3() throws Exception {
        ...
        // 创建SimpleRequestContext
        SimpleRopRequestContext requestContext = requestContextBuilder.buildBySysParams(ropContext, new Object(), null);
    }
