...
public class DefaultRopContextTest {
    ...
    public void testWithoutGroupService() {
        ...
        assertEquals(definition.isNeedAccessToken(), false);
    ...
    public void testWithGroupService() {
        ...
        assertEquals(definition2.isNeedAccessToken(), true);
    ...
    public class WithoutGroupService {
        ...
        @ServiceMethod(method = "service.method1", title = "测试方法1", group = "GROUP1", groupTitle = "分组1", tags = { "TAG1", "TAG2" }, ignoreSign = IgnoreSignType.YES, needAccessToken = NeedAccessTokenType.NO, timeout = 100, version = "1.0")
        public Object service1() {
            return null;
        }
    }

    @ServiceMethodBean(group = "GROUP1", groupTitle = "分组1", tags = { "TAG1", "TAG2" }, ignoreSign = IgnoreSignType.YES, needAccessToken = NeedAccessTokenType.NO, timeout = 100, version = "1.0")
    public class WithGroupService {
        ...
        @ServiceMethod(method = "service.method2", title = "测试方法2", group = "GROUP2", groupTitle = "分组2", tags = { "TAG11",
                "TAG21" }, ignoreSign = IgnoreSignType.NO, needAccessToken = NeedAccessTokenType.YES, timeout = 200, version = "2.0")
