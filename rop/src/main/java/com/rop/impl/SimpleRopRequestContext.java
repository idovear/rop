...
public class SimpleRopRequestContext implements RopRequestContext {
    ...
    public Session getSession() {
        if (session == null && ropContext != null && ropContext.getSessionManager() != null && getAccess_token() != null) {
            session = ropContext.getSessionManager().getSession(getAppKey(), getAccess_token());
        }
        return session;
    }

    public void addSession(String access_token, Session session) {
        this.access_token = access_token;
        this.session = session;
        if (ropContext != null && ropContext.getSessionManager() != null) {
            ropContext.getSessionManager().addSession(access_token, session);
        }
    }

    public void removeSession() {
        if (ropContext != null && ropContext.getSessionManager() != null) {
            ropContext.getSessionManager().removeSession(getAccess_token());
        }
    }
