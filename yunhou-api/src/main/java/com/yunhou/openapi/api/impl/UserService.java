...
import com.yunhou.openapi.api.UserServiceInterface;
...
public class UserService implements UserServiceInterface {
    ...
    public Object addUserOfV0_9(CreateUserRequest request) {
        ...
        if (reservesUserNames.contains(request.getUserName())) {
            return new BusinessServiceErrorResponse(request.getRopRequestContext(), USER_NAME_RESERVED, request.getUserName());
        } else {
    ...
    // ② Let this method service the sample.user.add method
