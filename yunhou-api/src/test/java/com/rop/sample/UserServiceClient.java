...
public class UserServiceClient {
    ...
    public void createSessionWithParamMap() {
        CompositeResponse response = ropClient.buildClientRequest().addParam("userName", "tomson")
                .addParam("password", "123456", true).get(LogonResponse.class, "user.getSession", "1.0");
    ...
    public void addUser() {
        ...
        // add1
        response = ropClient.buildClientRequest().post(createUserRequest, CreateUserResponse.class, "user.add", "1.0");
        assertNotNull(response);
        assertTrue(response.isSuccessful());
    ...
    public void testAddUserByVersion3() {
        ...
        CompositeResponse response = ropClient.buildClientRequest().post(ropRequest, CreateUserResponse.class, "user.add", "3.0");
        assertNotNull(response);
    ...
    public void testFileUpload() throws Throwable {
        ...
        CompositeResponse response = ropClient.buildClientRequest().post(request, UploadUserPhotoResponse.class,
